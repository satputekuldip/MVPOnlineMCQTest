...
public class Question {
    ...
    @Property(nameInDb = "test_id")
    private String testNo;

    @Expose
    @SerializedName("question_number")
    @Property(nameInDb = "question_number")
    ...
    @Property(nameInDb = "question_image_url")
    ...
    @Generated(hash = 615837786)
    public Question(Long id, String testNo, String questionNumber, String questionText,
            String imgUrl, String createdAt, String updatedAt) {
        this.id = id;
        this.testNo = testNo;
