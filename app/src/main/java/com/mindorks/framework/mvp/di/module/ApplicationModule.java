...
import com.mindorks.framework.mvp.data.file.AppFileHelper;
import com.mindorks.framework.mvp.data.file.FileHelper;
import com.mindorks.framework.mvp.data.file.FileManager;
...
import com.mindorks.framework.mvp.di.FileInfo;
...
public class ApplicationModule {
    ...
    String provideFilePath() {
        return AppConstants.FILE_ABSOLUTE_PATH;
    }
    ...
    /*@Provides
    @Singleton
    DataManager provideFileManager(FileManager fileManager) {
        return appDataManager;
    }*/
