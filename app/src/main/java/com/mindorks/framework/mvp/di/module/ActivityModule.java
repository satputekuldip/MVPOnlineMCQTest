...
import com.mindorks.framework.mvp.ui.importquestions.ImportQuestionsMvpPresenter;
import com.mindorks.framework.mvp.ui.importquestions.ImportQuestionsMvpView;
import com.mindorks.framework.mvp.ui.importquestions.ImportQuestionsPresenter;
...
import com.mindorks.framework.mvp.ui.sync.from.server.SyncFromServerMvpPresenter;
import com.mindorks.framework.mvp.ui.sync.from.server.SyncFromServerMvpView;
import com.mindorks.framework.mvp.ui.sync.from.server.SyncFromServerPresenter;
import com.mindorks.framework.mvp.ui.upload.UploadQuestionsMvpPresernter;
import com.mindorks.framework.mvp.ui.upload.UploadQuestionsMvpView;
import com.mindorks.framework.mvp.ui.upload.UploadQuestionsPresenter;
...
public class ActivityModule {
    ...
    @Provides
    @PerActivity
    ImportQuestionsMvpPresenter<ImportQuestionsMvpView> provideImportQuestionsPresenter(
            ImportQuestionsPresenter<ImportQuestionsMvpView> presenter) {
        return presenter;
    }

    @Provides
    @PerActivity
    SyncFromServerMvpPresenter<SyncFromServerMvpView> provideSyncFromServerPresenter(
            SyncFromServerPresenter<SyncFromServerMvpView> presenter) {
        return presenter;
    }

    @Provides
    @PerActivity
    UploadQuestionsMvpPresernter<UploadQuestionsMvpView> provideUploadQuestionsPresenter(
            UploadQuestionsPresenter<UploadQuestionsMvpView> presenter){
        return presenter;
    }
