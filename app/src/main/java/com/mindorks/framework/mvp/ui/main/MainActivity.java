...
import com.mindorks.framework.mvp.ui.importquestions.ImportQuestionsActivity;
import com.mindorks.framework.mvp.ui.login.LoginActivity;
import com.mindorks.framework.mvp.ui.main.rating.RateUsDialog;
import com.mindorks.framework.mvp.ui.sync.from.server.SyncFromServerActivity;
...
public class MainActivity extends BaseActivity implements MainMvpView {
    ...
    protected void setUp() {
        ...
        if (!checkPermission()) {
            ...
            onError("Permission already granted.");
        }
        ...
        mNavigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.nav_item_import_questions:
                                //mPresenter.onDrawerOptionAboutClick();
                                mPresenter.onDrawerOptionImportClick();
                                return true;
                            case R.id.nav_item_sync_from_server:
                                //mPresenter.onDrawerRateUsClick();
                                mPresenter.onDrawerOptionSyncClick();
                                return true;
                            case R.id.nav_item_upload_Questions:
                                //mPresenter.onDrawerMyFeedClick();
                                mPresenter.onDrawerOptionUploadClick();
                                return true;
    ...
    @Override
    public void openSyncServerActivity() {
        startActivity(SyncFromServerActivity.getStartIntent(this));
        //finish();
    }

    @Override
    public void openUploadQuestionsActivity() {
        startActivity(UploadQuestionsActivity.getStartIntent(this));
    }
    ...
    public void showContactUs() {
        ...
        getSupportFragmentManager()
                ...
                .disallowAddToBackStack()
                .setCustomAnimations(R.anim.slide_left, R.anim.slide_right)
                .add(R.id.cl_root_view, OpenSourceFragment.newInstance(), OpenSourceFragment.TAG)
                .commit();*/
    }
    ...
    @Override
    public void openImportQuestionsActivity() {
        startActivity(ImportQuestionsActivity.getStartIntent(this));
    }
