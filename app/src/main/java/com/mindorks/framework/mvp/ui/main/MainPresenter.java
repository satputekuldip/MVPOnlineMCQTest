...
public class MainPresenter<V extends MainMvpView> extends BasePresenter<V>
    ...
    @Override
    public void onDrawerOptionImportClick() {
        getMvpView().closeNavigationDrawer();
        getMvpView().openImportQuestionsActivity();
    }

    @Override
    public void onDrawerOptionUploadClick() {
        getMvpView().closeNavigationDrawer();
        getMvpView().openUploadQuestionsActivity();
    }

    @Override
    public void onDrawerOptionSyncClick() {
        getMvpView().closeNavigationDrawer();
        getMvpView().openSyncServerActivity();
    }
